...
async function main() {
  ...
  const networks = [
    {
      code: 'eth',
      chainId: 1,
      rpcUrl: 'http://135.125.163.236:4000/v1/rpc/eth',
      wsUrl: null,
      isTestnet: false,
      isEnabled: true,
    },
    {
      code: 'avax',
      chainId: 43114,
      rpcUrl: 'http://135.125.163.236:4000/v1/rpc/avax',
      wsUrl: null,
      isTestnet: false,
      isEnabled: true,
    },
    {
      code: 'bsc',
      chainId: 56,
      rpcUrl: 'http://135.125.163.236:4000/v1/rpc/bsc',
      wsUrl: null,
      isTestnet: false,
      isEnabled: true,
    },
    {
      code: 'opt',
      chainId: 10,
      rpcUrl: 'http://135.125.163.236:4000/v1/rpc/opt',
      wsUrl: null,
      isTestnet: false,
      isEnabled: true,
    },
    {
      code: 'arb-one',
      chainId: 42161,
      rpcUrl: 'http://135.125.163.236:4000/v1/rpc/arb-one',
      wsUrl: null,
      isTestnet: false,
      isEnabled: true,
    },
    {
      code: 'base',
      chainId: 8453,
      rpcUrl: 'http://135.125.163.236:4000/v1/rpc/base',
      wsUrl: null,
      isTestnet: false,
      isEnabled: true,
    },
    {
      code: 'poly',
      chainId: 137,
      rpcUrl: 'http://135.125.163.236:4000/v1/rpc/poly',
      wsUrl: null,
      isTestnet: false,
      isEnabled: true,
    },
  ...
  // Create default API key (without hashing for now)
  const defaultApiKey = await prisma.apiKey.create({
    data: {
      label: 'Default API Key',
      keyHash: 'default-key-hash-123', // This should be replaced with actual key generation
